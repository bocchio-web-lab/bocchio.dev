...
<div class="container mx-auto space-y-8 py-8">
    ...
    <Card.Root class="max-w-2xl mx-auto">
        <Card.Header>
            ...
            <Card.Description
                >Your personal details and account status</Card.Description
            >
        </Card.Header>
        <Card.Content>
            <div class="space-y-6">
    ...
    <Card.Root class="max-w-2xl mx-auto">
        <Card.Header>
            ...
            <Card.Description
                >Manage your account security and preferences</Card.Description
            >
        </Card.Header>
        ...
        <Card.Footer
            class="flex flex-col items-start gap-4 sm:flex-row sm:justify-between"
        >
