...
<Card.Root class="prose-custom mx-auto w-full max-w-4xl">
	<Card.Header>
		<h1>Privacy Policy</h1>
		<span>Last updated November 14, 2025</span>
	</Card.Header>

	<Card.Content>
		<p>
			This Privacy Notice for Tommaso Bocchietti ("<strong>we</strong>," "<strong>us</strong>," or "<strong
				>our</strong
		...
		<ul>
			<li>
				...
				<a
					target="_blank"
					href="https://bocchio.dev">https://bocchio.dev</a
				>
		...
		<p>
			...
			<a
				target="_blank"
				href="mailto:tommaso.bocchietti@gmail.com">tommaso.bocchietti@gmail.com</a
			>.
		</p>
		...
		<p>
			<strong
				><em
					...
					using our&nbsp;<a href="#toc"><strong><em>table of contents</em></strong></a><strong
		...
		<p>
			...
			Services, the choices you make, and the products and features you use. Learn more about&nbsp;<a
				href="#personalinfo">personal information you disclose to us</a
			>.
		</p>

		<p>
			<strong>Do we process any sensitive personal information?&nbsp;</strong>Some of the
			information may be considered "special" or "sensitive" in certain jurisdictions, for example
			your racial or ethnic origins, sexual orientation, and religious beliefs. We do not process
		...
		<p>
			...
			We may share information in specific situations and with specific third parties. Learn more about&nbsp;<a
				href="#whoshare">when and with whom we share your personal information</a
			>.
		</p>
		...
		<p>
			...
			access, steal, or modify your information. Learn more about&nbsp;<a href="#infosafe"
		...
		<p>
			...
			by
			<a
				href="https://app.termly.io/dsar/be8aeea7-00c5-4c5f-b752-26a2892fd4ff"
				rel="noopener noreferrer"
				target="_blank">submitting a&nbsp;data subject access request</a
		...
		<p>
			...
			You can find out more about this in our Cookie Notice: bocchio.dev/cookies.
		</p>
		...
		<ul class="list-square">
			...
			<li>
				...
				We may process your personal information when we believe it is necessary to fulfill our contractual
				obligations to you, including providing our Services or at your request prior to entering into
				a contract with you.
			</li>
			<li>
		...
		<p>
			...
			is set out in our Cookie Notice: bocchio.dev/cookies.
		</p>
		...
		<p>
			<strong><em>In Short:</em></strong><em>
				We do not knowingly collect data from or market to children under 18 years of age.</em
			>
		</p>
		<p>
		...
		<p>
			...
			<a
				...
				rel="noopener noreferrer"
				target="_blank">Member State data protection authority</a
			>
			or
			<a
		...
		<p>
			...
			withdraw your consent at any time. You can withdraw your consent at any time by contacting us
			by using the contact details provided in the section "<a href="#contact"
				>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a
			>" below.
		</p>
		<p>
		...
		<p>
			...
			or reject cookies, this could affect certain features or services of our Services. For further
			information, please see our Cookie Notice: bocchio.dev/cookies.
		</p>
		<p>
		...
		<p class="not-prose">
			Tommaso Bocchietti<br />
			Via Montagnola, 13<br />
			San Fermo della Battaglia, Lombardia 22042<br />
			Italy
		</p>
		...
		<p>
			...
			some circumstances by applicable law. To request to review, update, or delete your personal
