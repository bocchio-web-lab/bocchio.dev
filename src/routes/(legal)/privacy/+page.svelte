...
<Card.Root class="prose-custom mx-auto w-full max-w-4xl">
    ...
    <Card.Content>
        <p>
            This Privacy Notice for Tommaso Bocchietti ("<strong>we</strong>," "<strong
                >us</strong
            >," or "<strong>our</strong>"), describes how and why we might
            access, collect, store, use, and/or share ("<strong>process</strong
            >") your personal information when you use our services ("<strong
                >Services</strong
            >"), including when you:
        </p>
        ...
        <ul>
            <li>
                ...
                <a target="_blank" href="https://bocchio.dev"
                    >https://bocchio.dev</a
                >
        ...
        <p>
            ...
            <a target="_blank" href="mailto:tommaso.bocchietti@gmail.com"
                >tommaso.bocchietti@gmail.com</a
            >.
        </p>
        ...
        <p>
            ...
            more about&nbsp;<a href="#personalinfo"
        ...
        <p>
            ...
            have a valid legal reason to do so. Learn more about&nbsp;<a
                href="#infouse">how we process your information</a
            >.
        </p>
        ...
        <p>
            ...
            parties. Learn more about&nbsp;<a href="#whoshare"
        ...
        <p>
            ...
            Cookie Notice: bocchio.dev/cookies.
        </p>
        ...
        <ul class="list-square">
            ...
            <li>
                ...
                your device. However, if you choose to opt out, you may not be able
        ...
        <ul class="list-square">
            ...
            <li>
                ...
                to fulfill our contractual obligations to you, including providing
                our Services or at your request prior to entering into a contract
                with you.
            </li>
            <li>
        ...
        <p>
            ...
            using the contact details provided in the section "<a
